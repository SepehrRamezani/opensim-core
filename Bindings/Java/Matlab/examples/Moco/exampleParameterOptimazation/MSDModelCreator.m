...
muscle1.set_tendon_compliance_dynamics_mode(Muscledynamic);
...
muscle1.addNewPathPoint('muscle1-point2', block, Vec3(0,0.05,-0.05))
...
muscle2.set_tendon_compliance_dynamics_mode(Muscledynamic);
...
muscle2.addNewPathPoint('muscle2-point2', block, Vec3(0,0.05,0.05))
